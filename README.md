# Portfolio QA – Florencia Raquel Posse 
...
🔗 [Ver Web Portfolio QA](https://florenciaposse.github.io/QAtester/)
...
- URL API (requiere acceso): [Supabase API](https://supabase.com/dashboard/project/iwdierxmgildaqzycppj/editor)  
- Documentación de la API: [Documentación API](https://bootcamp-qa.github.io/ReportGenerator/documentacionapi.html) 
---
